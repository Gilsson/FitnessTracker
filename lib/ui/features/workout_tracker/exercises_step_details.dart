...
import 'package:fitness_sync/common_widget/step_detail_row.dart';
...
class _ExercisesStepDetailsState extends State<ExercisesStepDetails> {
  ...
  List<Map<String, String>> generateGuideSteps(List<String> guide) {
    return List<Map<String, String>>.generate(guide.length, (index) {
      return {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      stepArr = generateGuideSteps(widget.eObj["guide"] as List<String>);
      setState(() {
        _isLoading = false;
      });
    });
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "${widget.eObj["difficulty"]} | ${widget.eObj["calories"]} Calories Burn",
                style: TextStyle(
                  color: TColor.gray,
                  fontSize: 12,
                ),
